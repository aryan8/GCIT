...
<table class="table" id="branchesTable">
	...
	<td><button class="btn btn-success" data-toggle="modal"
						data-target="#editauthormodal" onclick="javascript:location.href='viewbooks?branchId=<%=b.getBranchId()%>&cardNo=<%=cardNo%>'"><span
										class="glyphicon glyphicon-eye-open"></span>Pick</button>
	</tr>
	<%} %>
